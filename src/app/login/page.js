...
export default function LoginPage() {
  ...
  return (
    <div className="ps-page">
      ...
      <style jsx>{`
        .lg-wrapper { position:relative; z-index:10; min-height:100vh; display:flex; align-items:center; justify-content:center; padding:20px; background:#0a0a0a; }
        ...
        .lg-logo-icon { width:42px;height:42px; border-radius:12px; background:linear-gradient(135deg,#ff3020,#ff6040); display:flex; align-items:center; justify-content:center; font-family:'Genos',sans-serif; font-weight:900; font-size:16px; color:#fff; }
        .lg-logo-text { font-family:'Genos',sans-serif; font-size:22px; font-weight:800; color:#fff; letter-spacing:2px; text-transform:uppercase; }
        ...
        .lg-pw-toggle { position:absolute; right:14px; top:50%; transform:translateY(-50%); background:transparent; border:none; color:rgba(255,255,255,0.3); font-size:12px; cursor:pointer; font-family:'Genos',sans-serif; letter-spacing:1px; }
        .lg-pw-toggle:hover { color:#ff6040; }

        .lg-link { text-align:center; font-size:12px; color:rgba(255,255,255,0.3); margin-top:16px; }
        .lg-link a, .lg-link span.lg-link-btn { color:#ff6040; text-decoration:none; font-family:'Genos',sans-serif; letter-spacing:1px; cursor:pointer; }
        ...
        .lg-success-title { font-family:'Genos',sans-serif; font-size:18px; font-weight:700; color:#44ff66; letter-spacing:1.5px; text-transform:uppercase; margin-bottom:8px; }
        ...
        .lg-tab { flex:1; padding:10px 0; text-align:center; border-radius:9px; font-family:'Genos',sans-serif; font-size:12px; font-weight:700; letter-spacing:1.5px; text-transform:uppercase; cursor:pointer; transition:all 0.3s ease; color:rgba(255,255,255,0.3); border:none; background:transparent; }
        ...
        .lg-otp-input { text-align:center; font-size:24px; letter-spacing:12px; font-family:'Genos',sans-serif; font-weight:700; }
        ...
        @keyframes psFadeIn { from { opacity:0; transform:translateY(12px); } to { opacity:1; transform:translateY(0); } }

        .ps-input { width:100%; padding:14px 18px; border-radius:12px; border:1px solid rgba(255,255,255,0.08); background:rgba(255,255,255,0.04); color:#fff; font-size:14px; font-family:'DM Sans',sans-serif; outline:none; transition:all 0.3s ease; }
        .ps-input:focus { border-color:rgba(255,60,30,0.4); background:rgba(255,255,255,0.06); }
        .ps-input::placeholder { color:rgba(255,255,255,0.2); }

        .ps-btn { padding:14px 28px; border-radius:12px; font-size:15px; font-weight:700; font-family:'DM Sans',sans-serif; cursor:pointer; transition:all 0.3s ease; border:none; }
        .ps-btn:disabled { opacity:0.5; cursor:not-allowed; }
        .ps-btn-primary { background:linear-gradient(135deg,#ff3020,#ff6040); color:#fff; box-shadow:0 0 30px rgba(255,50,30,0.2); }
        .ps-btn-primary:hover:not(:disabled) { box-shadow:0 0 40px rgba(255,50,30,0.35); transform:translateY(-1px); }
        .ps-btn-secondary { background:rgba(255,255,255,0.04); color:rgba(255,255,255,0.4); border:1px solid rgba(255,255,255,0.08); }
      ...
      <div className="lg-wrapper">
        <div className="lg-card">
          <div className="lg-logo">
            ...
            <div className="lg-logo-text">{EVENT_CONFIG ? EVENT_CONFIG.eventName : "Project Space"}</div>
          </div>
          ...
          {/* ===== TEAM LEADER FLOW (no First Time tab) ===== */}
          {role === "leader" && (
            <form className="lg-form" onSubmit={handleLogin}>
              <input type="text" value={rollNumber} onChange={function (e) { setRollNumber(e.target.value.toUpperCase()) }} placeholder="Roll Number (e.g. 22A31A0501)" className="ps-input" style={{ width: "100%", textAlign: "center", fontSize: 15, letterSpacing: 2, fontFamily: "'Genos',sans-serif" }} autoFocus />
