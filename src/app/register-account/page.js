...
export default function RegisterAccountPage() {
  ...
  var [accountCreated, setAccountCreated] = useState(false)
  ...
  return (
    <div className="ps-page">
      ...
      <style jsx>{`
        ...
        .ra-success { text-align:center; padding:10px 0; }
        .ra-success-icon { font-size:52px; margin-bottom:16px; display:block; }
        .ra-success-title { font-family:'DM Sans',sans-serif; font-size:20px; font-weight:800; color:#fff; letter-spacing:1.5px; margin-bottom:8px; }
        .ra-success-sub { font-family:'DM Sans',sans-serif; font-size:13px; color:rgba(255,255,255,0.4); margin-bottom:28px; line-height:1.6; }
        .ra-success-btn { display:block; width:100%; padding:15px; border-radius:12px; background:linear-gradient(135deg,#ff3020,#ff6040); color:#fff; font-family:'DM Sans',sans-serif; font-size:14px; font-weight:700; letter-spacing:2px; text-transform:uppercase; text-decoration:none; text-align:center; box-shadow:0 4px 20px rgba(255,50,30,0.3); transition:all 0.3s; box-sizing:border-box; }
        .ra-success-btn:hover { transform:translateY(-2px); box-shadow:0 6px 30px rgba(255,50,30,0.45); }
        @media (max-width:500px) { .ra-card { padding:28px 20px; } .ra-logo-text { font-size:18px; } }
      `}</style>
        ...
        <div className="ra-card">
          ...
          {accountCreated && (
            <div className="ra-success">
              <span className="ra-success-icon">✅</span>
              <div className="ra-success-title">Account Created!</div>
              <div className="ra-success-sub">Your account is ready.<br />Click below to log in and register your team.</div>
              <a href={"/login-simple?roll=" + rollNumber.trim().toUpperCase()} className="ra-success-btn">Log In Now →</a>
            </div>
          )}

          {/* STEPS — only shown before account created */}
          {!accountCreated && (
            <>
                ...
                <div>
                  ...
                  <form className="ra-form" onSubmit={handleVerifyOTP}>
                    ...
                    <div className="ra-resend">
                      <button type="button" className="ra-resend-btn" disabled={resendTimer > 0} onClick={function () { handleSendOTP() }}>
